...
// Included in the font stack unconditionally: browsers skip unknown font
// family names, so it's harmless in contexts where the @font-face isn't
// defined (emails, client-side theme changes, fonts without known metrics).
