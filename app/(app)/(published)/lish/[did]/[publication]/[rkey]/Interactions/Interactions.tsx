...
import { decodeQuotePosition, QuotePosition } from "src/utils/quotePosition";
...
export const ExpandedInteractions = (props: {
  ...
  return (
    ...
    >
      ...
      <hr className="border-border-light mb-3 " />
      <div className="expandedInteractions relative flex gap-4 justify-start font-bold mx-auto">
        {noInteractions ? (
          <div />
        ) : (
...
const EditButton = (props: {
  ...
  if (
    ...
    return (
      ...
      >
        <EditTiny />
        {/* Out of flow it can't shrink the row to make room, so on phone-width
        cards it drops to the icon alone rather than running off the edge. */}
