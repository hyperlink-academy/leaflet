...
function MetaRow({
  ...
  return (
    <div
      className={`sm:justify-between place-items-start! sm:place-items-center! w-full ${textClassName} text-tertiary flex sm:flex-row flex-col gap-1 flex-wrap items-center`}
    >
      <p
