...
export function MetaRow({
  ...
  return (
    <div
      className={`metaRow flex sm:flex-row flex-col sm:gap-2 gap-1 sm:items-center w-full text-tertiary ${textClassName} ${compact && "sm:gap-1! sm:flex-col! sm:items-start"}`}
    >
      <div
