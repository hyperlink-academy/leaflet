...
export default async function PublicationDashboardLayout(props: {
  ...
  return (
    // The (published) group layout above streams identity in; re-seed the
    // context with the identity this layout already awaited so the dashboard
    // renders logged-in state in the SSR HTML, as it did under the (app)
    // layout.
