...
alter table "public"."permission_token_creator" add constraint "permission_token_creator_identity_fkey" FOREIGN KEY (identity) REFERENCES identities(id) ON DELETE CASCADE not valid;

alter table "public"."permission_token_creator" validate constraint "permission_token_creator_identity_fkey";

alter table "public"."permission_token_creator" add constraint "permission_token_creator_token_fkey" FOREIGN KEY (token) REFERENCES permission_tokens(id) ON DELETE CASCADE not valid;
