...
create table "public"."pending_email_subscriptions_to_entity" (
    "id" uuid not null default gen_random_uuid(),
    "entity" uuid not null,
    "email" text not null,
    "created_at" timestamp with time zone not null default now(),
...
alter table "public"."pending_email_subscriptions_to_entity" enable row level security;

CREATE UNIQUE INDEX email_subscriptions_to_entity_pkey ON public.email_subscriptions_to_entity USING btree (id);

CREATE UNIQUE INDEX pending_subscriptions_to_entity_pkey ON public.pending_email_subscriptions_to_entity USING btree (id);
...
alter table "public"."pending_email_subscriptions_to_entity" add constraint "pending_subscriptions_to_entity_pkey" PRIMARY KEY using index "pending_subscriptions_to_entity_pkey";
...
alter table "public"."pending_email_subscriptions_to_entity" add constraint "pending_subscriptions_to_entity_entity_fkey" FOREIGN KEY (entity) REFERENCES entities(id) ON DELETE CASCADE not valid;

alter table "public"."pending_email_subscriptions_to_entity" validate constraint "pending_subscriptions_to_entity_entity_fkey";
...
grant delete on table "public"."pending_email_subscriptions_to_entity" to "anon";

grant insert on table "public"."pending_email_subscriptions_to_entity" to "anon";

grant references on table "public"."pending_email_subscriptions_to_entity" to "anon";

grant select on table "public"."pending_email_subscriptions_to_entity" to "anon";

grant trigger on table "public"."pending_email_subscriptions_to_entity" to "anon";

grant truncate on table "public"."pending_email_subscriptions_to_entity" to "anon";

grant update on table "public"."pending_email_subscriptions_to_entity" to "anon";

grant delete on table "public"."pending_email_subscriptions_to_entity" to "authenticated";

grant insert on table "public"."pending_email_subscriptions_to_entity" to "authenticated";

grant references on table "public"."pending_email_subscriptions_to_entity" to "authenticated";

grant select on table "public"."pending_email_subscriptions_to_entity" to "authenticated";

grant trigger on table "public"."pending_email_subscriptions_to_entity" to "authenticated";

grant truncate on table "public"."pending_email_subscriptions_to_entity" to "authenticated";

grant update on table "public"."pending_email_subscriptions_to_entity" to "authenticated";

grant delete on table "public"."pending_email_subscriptions_to_entity" to "service_role";

grant insert on table "public"."pending_email_subscriptions_to_entity" to "service_role";

grant references on table "public"."pending_email_subscriptions_to_entity" to "service_role";

grant select on table "public"."pending_email_subscriptions_to_entity" to "service_role";

grant trigger on table "public"."pending_email_subscriptions_to_entity" to "service_role";

grant truncate on table "public"."pending_email_subscriptions_to_entity" to "service_role";

grant update on table "public"."pending_email_subscriptions_to_entity" to "service_role";
