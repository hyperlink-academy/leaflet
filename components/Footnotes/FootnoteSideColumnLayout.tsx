...
function SideItem(props: {
  ...
  return (
    <div
      ...
      className={`absolute left-0 right-0 text-sm footnote-side-enter footnote-side-item${overflows ? " has-overflow" : ""}${isFocused ? " footnote-side-focused" : ""}${props.hasPageBackground ? " bg-bg-page rounded-md px-2 py-1 ![mask-image:none] opacity-[calc(var(--bg-page-alpha,1)*0.7)] [&_.footnote-item>.grow]:line-clamp-3" : ""}`}
      style={{ top: props.top }}
    >
      {props.children}
    </div>
