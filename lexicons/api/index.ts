...
import * as PartsPageEmbedCtx from './types/parts/page/embed/ctx'
...
import * as PubLeafletBlocksImageGallery from './types/pub/leaflet/blocks/imageGallery'
import * as PubLeafletBlocksMath from './types/pub/leaflet/blocks/math'
import * as PubLeafletBlocksMembersOnlyDelimiter from './types/pub/leaflet/blocks/membersOnlyDelimiter'
...
export * as PartsPageEmbedCtx from './types/parts/page/embed/ctx'
...
export * as PubLeafletBlocksImageGallery from './types/pub/leaflet/blocks/imageGallery'
export * as PubLeafletBlocksMath from './types/pub/leaflet/blocks/math'
export * as PubLeafletBlocksMembersOnlyDelimiter from './types/pub/leaflet/blocks/membersOnlyDelimiter'
...
export class SiteStandardGraphNS {
  _client: XrpcClient
  recommend: SiteStandardGraphRecommendRecord
  subscription: SiteStandardGraphSubscriptionRecord

  constructor(client: XrpcClient) {
    this._client = client
    this.recommend = new SiteStandardGraphRecommendRecord(client)
    this.subscription = new SiteStandardGraphSubscriptionRecord(client)
  }
}

export class SiteStandardGraphRecommendRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: SiteStandardGraphRecommend.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    ...
    uri: string
    cid: string
    value: SiteStandardGraphRecommend.Record
  }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'site.standard.graph.recommend',
      ...params,
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<SiteStandardGraphRecommend.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'site.standard.graph.recommend', ...params },
      { headers },
    )
  }
}
